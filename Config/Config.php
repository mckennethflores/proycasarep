<?php
//
const BASE_URL = "http://localhost/casarepososurco";

// Produccion
// const BASE_URL = "https://proyajkon.com";

date_default_timezone_set('America/Lima');


/* const DB_HOST = "localhost";
const DB_NAME = "kenneth2_proyajkondb";
const DB_USER = "kenneth2_proyajkonus";
const DB_PASSWORD = "PR$;jmqb?E.y"; */

const DB_HOST = "localhost";
const DB_NAME = "casareposodb";
const DB_USER = "root";
const DB_PASSWORD = "";
...
/* 	+1 (954) 630-5627 */
	...
	const CODIGO = "51";
	const CELULAR1 = "918367638";
	const CELULAR2 = "916835106";
	const PAIS = "+51";
	...
	const DIRECCION = "Ismael Bielich 761 <br> Santiago de Surco <br> Alt. de las cuadras 24 y 25 <br> de Caminos del Inca";
	
	const CAT_SLIDER = "13,17";
	const CAT_BANNER = "13,17";

	const CATEGORIA_TRES = "1";
