...
<html lang="es-PE">
  <head>
    ...
    <link rel="shortcut icon" href="<?= media();?>/images/favicon3.ico" type="image/x-icon">
    <meta name="author" content="McKenneth Flores">
    <meta name="msapplication-TileColor" content="#214c18cc">
    <meta name="theme-color" content="#214c18cc">
    ...
    <link rel="stylesheet" type="text/css" href="<?= media();?>/css/administrador/bootstrap-select.min.css"> 
    <link rel="stylesheet" type="text/css" href="<?= media(); ?>/css/administrador/style.css">
  
  </head>
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard"><?= NOMBRE_EMPRESA ?></a>
      <!-- Sidebar toggle button-->
      <a class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"><i class="fa-regular fa-bars"></i></a>
      <!-- Navbar Right Menu-->
      <ul class="app-nav">
        <!-- User Menu-->
        <li class="dropdown">
