    ...
    <aside class="app-sidebar">
      ...
      <li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <!--  <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/categoriauno"><i class="icon fa fa-circle-o"></i> Modulo Categorías</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][7]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/categoriados"><i class="icon fa fa-circle-o"></i> Categorías</a></li>
                <?php } ?> -->
        ...
        <?php if(!empty($_SESSION['permisos'][MODPAGINAS]['r'])){ ?>
        <li>
