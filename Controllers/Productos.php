<?php
	class Productos extends Controllers{
		...
		public function Productos()
		{
			...
			$data['page_tag'] = "Inmueble";
			$data['page_title'] = "Inmueble <small>Tienda Virtual</small>";
		...
		/* 	dep($_POST);
			return; */
			if($_POST){
				if(empty($_POST['txtNombre']) || empty($_POST['txtCodigo']) || empty($_POST['txtPrecioDolares']) || empty($_POST['listStatus']) )
				{
					...
					$intCategoriatresId = intval($_POST['listCategoriatres']);
					$strPrecioDolares = strClean($_POST['txtPrecioDolares']);
					$strPrecioDolaresIgv = strClean($_POST['txtPrecioDolaresIgv']);
					$strPrecioSoles = strClean($_POST['txtPrecioSoles']);
					$strPrecioSolesIgv = strClean($_POST['txtPrecioSolesIgv']);
					$intStock = intval($_POST['txtStock']);
					$strModelo = intval($_POST['txtModelo']);
					$intStatus = intval($_POST['listStatus']);
					$intMarcasId = intval($_POST['listMarcas']);
					$intCaracteristicasId = intval($_POST['listCaracteristicas']);
					$strDatosDscto = intval($_POST['txtDatosdscto']);
					$strPorcentajedscto = intval($_POST['txtPorcentajedscto']);
					$strPreciodscto = intval($_POST['txtPreciodscto']);
					$strResumen = strClean($_POST['txtResumen']);
					$strCaracteristica = strClean($_POST['txtCaracteristica']);
